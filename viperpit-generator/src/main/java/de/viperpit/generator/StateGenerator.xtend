...
class StateGenerator {
	...
	private def toRole(KeyCodeLine it) {
		switch (description) {
			...
			case description.endsWith(" DECR"): "decrease"
			case description.endsWith(" Decr"): "decrease"
			case description.endsWith(" Decr."): "decrease"
			case description.endsWith(" Decrease"): "decrease"
			case description.endsWith(" UP"): "up"
			case description.endsWith(" Up"): "up"
			case description.contains(" INCR"): "up"
			case description.endsWith(" Incr"): "increase"
			case description.endsWith(" Incr."): "increase"
			case description.endsWith(" Increase"): "increase"
	...
	private def toStyle(KeyCodeLine it, Iterable<KeyCodeLine> keyCodeLines) {
		...
		return switch (group) {
			...
			case group.contains("Knob") && #{"up", "down", "increase", "decrease", "left", "right"}.contains(role): "button"
