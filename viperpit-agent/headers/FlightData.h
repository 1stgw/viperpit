...
public:
    ...
    // VERSION 19
    enum EcmBits            // Note: these are currently not combinable bits, but mutually exclusive states!
    {
...
public:
    ...
    struct StringStruct
    {
        ...
        char* strData;              // Data storage blob for the string
    ...
    struct StringStruct data[];     // Data storage blob for all the strings
