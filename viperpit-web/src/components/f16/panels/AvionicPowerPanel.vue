<template>
  <v-card outlined>
    <v-card-title>AVIONIC POWER PANEL</v-card-title>
    <v-container>
      <v-row>
        <v-col>
          <switch-group
            id="AVIONICS: INS Knob"
